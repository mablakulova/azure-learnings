...
namespace AzureBlobManager.Application.Common.Exceptions;
...
public class InputValidationException : Exception
{
    ...
    public InputValidationException(params (string PropertyName, string ErrorMessage)[] failures)
       : this()
    {
        SaveGroupedErrors(failures);
    }

    public InputValidationException(Exception? innerException, params (string PropertyName, string ErrorMessage)[] failures) 
       : this(innerException)
    {
        SaveGroupedErrors(failures);
    }
